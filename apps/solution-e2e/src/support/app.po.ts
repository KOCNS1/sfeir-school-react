...
export const getInput = (id) => cy.get(`[data-cy='input-${id}']`);
...
/**
 * Find an input and type in it (cleans everytime)
 * @param text to type
 * @param id to find
 * @returns
 */
export const typeInInput = (text: string, id: string) => getInput(id).clear().type(text)
